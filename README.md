...
- **APK:** `app/Version 1.0.0/Sentinel-v1.0.0.apk` — install on Android 7.0+ (API 24).
- **Source code:** `app/Version 1.0.0/Sentinel-app-source-v1.0.0.zip` — app source only (src/, res/, AndroidManifest.xml).
